<?php
/**
 * PhpThumb Library Definition File (renamed from PhpThumb to DDM_Image to fit our framework)
 *
...
define('THUMBLIB_BASE_PATH', PROJECT_ROOT .  'library/DDM/Image/PhpThumb');
