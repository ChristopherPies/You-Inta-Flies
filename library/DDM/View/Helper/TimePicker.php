 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class DDM_View_Helper_TimePicker extends ZendX_JQuery_View_Helper_UiWidget
{
    /**
    ...
    public function TimePicker($id, $value = null, array $params = array(), array $attribs = array())
    {
        ...
        $js = sprintf('%s("#%s").timepicker('.$params.');',
                ZendX_JQuery_View_Helper_JQuery::getJQueryHandler(),
                $attribs['id']
        );

        $this->jquery->AddJavascriptFile('/js/lib/jQueryPlugins/jquery-ui-timepicker-addon-0.9.7.js');
