 ...
 *
 */
class DDM_View_Smarty_Plugin_Standard extends DDM_View_Smarty_Plugin_Abstract {
     ...
     * @return null
     */
    public static function layoutFunction($params, Smarty &$smarty) {
     ...
     * @return string
     */
    public static function headTitleFunction($params, Smarty &$smarty) {
     ...
     * @return string
     */
    public static function headScriptFunction($params, Smarty &$smarty) {
        $method = (isset ( $params ['method'] )) ? $params ['method'] : - 1;
        unset ( $params ['method'] );
        $args = (isset ( $params ['args'] )) ? self::parseArgs ( $params ['args'] ) : null;
        $toReturn = "";
     ...
     * @return string
     */
    public static function jsLocaleFunction($params, Smarty &$smarty) {
        $method = (isset ( $params ['method'] )) ? $params ['method'] : - 1;
        unset ( $params ['method'] );
        $args = (isset ( $params ['args'] )) ? self::parseArgs ( $params ['args'] ) : null;
        $toReturn = "";
     ...
     * @return string
     */
    public static function headStyleFunction($params, Smarty &$smarty) {
        $method = (isset ( $params ['method'] )) ? $params ['method'] : - 1;
        unset ( $params ['method'] );
        $args = (isset ( $params ['args'] )) ? self::parseArgs ( $params ['args'] ) : null;
        $toReturn = "";
