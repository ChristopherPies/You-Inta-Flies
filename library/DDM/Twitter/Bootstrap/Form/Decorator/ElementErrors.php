 ...
 * @author Christian Soronellas <csoronellas@emagister.com>
 */
class DDM_Twitter_Bootstrap_Form_Decorator_ElementErrors extends Zend_Form_Decorator_Abstract
{
    /**
    ...
    public function render($content)
    {
        ...
        return $content . '<span class="help-inline">' . htmlentities($errors) . '</span>';
    }
}